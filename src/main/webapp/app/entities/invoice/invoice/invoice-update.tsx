        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : invoiceEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="productOrderIdLabel" for="invoice-productOrderId">
                  <Translate contentKey="storeApp.invoiceInvoice.productOrderId">Product Order Id</Translate>
                </Label>
                <AvField
                  id="invoice-productOrderId"
                  type="string"
                  className="form-control"
                  name="productOrderId"
                  validate={{
